    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="studentindex.php">Home<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="pics/newlogo.png" alt="#" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="pics/mb.jpg" alt="#" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="pics/apj.png" alt="#" width="1100" height="500">
    </div>
     <div class="carousel-item">
       <img src="pics/logo.jpg" alt="#" width="1100" height="500">
     </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/google.png" class="img-fluid pb-2">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/dell.png" class="img-fluid pb-1">
      </div>
      <div class="col-lg-2 col-md-2 col-4">
        <img src="pics/mc.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-4">
        <img src="pics/acc.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-4">
        <img src="pics/ibm.png" class="img-fluid pb-2">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/infosys-Logo.png" class="img-fluid pb-1">
      </div>
      <div class="col-lg-2 col-md-2 col-4">
        <img src="pics/bby.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-3 col-md-3 col-2">
        <img src="pics/amz.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/Sm.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/bosch.jpg" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/cogz.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/adobe.jpg" class="img-fluid pb-4">
      </div>
      <div class="col-lg-3 col-md-3 col-3">
        <img src="pics/flip.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/link.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
        <img src="pics/tata.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-3 col-md-3 col-3">
        <img src="pics/hcl.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-3 col-md-2 col-3">
        <img src="pics/sch.jpg" class="img-fluid pb-4">
      </div>
      <div class="col-lg-3 col-md-2 col-3">
        <img src="pics/nuclei.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-3 col-md-3 col-3">
        <img src="pics/per.png" class="img-fluid pb-4">
      </div>
      <div class="col-lg-2 col-md-2 col-3">
